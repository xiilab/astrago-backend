...
public enum StorageErrorCode implements ErrorCode {
	...
	FAILD_DELETE_USING_STORAGE(HttpStatus.METHOD_NOT_ALLOWED.value(), "해당 스토리지를 사용중인 데이터 셋, 모델이 존재해 삭제할 수 없습니다."),
	...
	DELL_STORAGE_STORAGE_VOLUME_ID_NULL(HttpStatus.INTERNAL_SERVER_ERROR.value(), "DELL 스토리지 STORAGE VOLUME ID를 입력해주세요."),
	;
