...
public enum UserErrorCode implements ErrorCode {
	...
	USER_CREATE_FAIL_SAME_NAME(HttpStatus.CONFLICT.value(), "사용자 UserName 중복"),
	USER_CREATE_FAIL_SAME_EMAIL(HttpStatus.CONFLICT.value(), "사용자 EMAIL 중복"),
	...
	USER_ADD_WORKSPACE_FAIL(HttpStatus.NOT_FOUND.value(), "워크스페이스에 회원 추가 실패하였습니다."),
	USER_NOT_FOUND_INFO(HttpStatus.NOT_FOUND.value(), "일치하는 정보가 없습니다."),

	GROUP_NOT_FOUND(HttpStatus.NOT_FOUND.value(), "해당 이름의 워크스페이스가 없습니다."),
	;
