...
public enum NodeErrorCode implements ErrorCode {
	...
	GPU_MEMORY_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR.value(), "gpu product에 메모리가 존재하지 않습니다. ex)A100-PCIE-80GB"),
	MIG_PROFILE_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR.value(), "MIG Profile 파일이 존재하지 않습니다. 관리자에게 문의바랍니다."),
