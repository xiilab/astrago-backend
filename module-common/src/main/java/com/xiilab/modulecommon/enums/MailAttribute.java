...
public enum MailAttribute{
	...
	WORKLOAD_DELETE_SCHEDULED("[Astrago] 워크로드 삭제 예정 알림", "워크로드 삭제 예정 안내",
		"<b>자원 사용률이 일정 시간 동안 <br/>기준값을 초과하지 않아 <span style=\"color:#5b29c7;\">1시간 후</span> 삭제될 예정입니다.</b><br/><br/><div>현재 사용자님의 워크로드가 관리자가 설정한 운영시간인 24시간 동안<br/>사용되지 않아 자원 최적화 정책에 따라 1시간 후 삭제될 예정입니다.<br/>삭제된 워크로드에 대한 정보는 복구되지 않습니다.</div>",
		"워크로드 안내 <br>", ""),
	// 라이센스
