...
public enum MailAttribute{
	...
	WORKLOAD_ERROR("[Astrago] 워크로드(%s) 에러 알림","워크로드(%s)에 에러가 발생하였습니다.","에러 일시 : %s","", "감사합니다."),
	WORKLOAD_DELETE("[Astrago] 워크로드(%s) 삭제 알림","워크로드(%s)를 삭제하였습니다.","삭제일시 : %s","", "감사합니다."),
	...
	MIG_ERROR("[Astrago] 노드 장애 알림","node1에 MIG 적용이 실패했습니다.","","", "감사합니다."),
