...
public enum MailAttribute{
	...
	WORKSPACE_CREATE("[Astrago] 워크스페이스(%s) 생성 알림","%s(%s)님이 <br>워크스페이스(%s)을(를) 생성하였습니다.","워크스페이스 생성내역은 아래와 같습니다.","리소스 쿼터","감사합니다."),
	...
	WORKSPACE_RESOURCE_RESULT("[Astrago] 워크스페이스(%s) 리소스 결과 알림","%s(%s)님이 <br>워크스페이스(%s) 리소스 요청을 %s 하였습니다. <br>%s","%s","<리소스 신청량>","감사합니다."),
	WORKSPACE_DELETE("[Astrago] 워크스페이스(%s) 삭제 알림","워크스페이스(%s)이(가) 삭제되었습니다.","","","감사합니다."),
	WORKSPACE_MEMBER_UPDATE("[Astrago] 워크스페이스(%s) 멤버 변경 알림","워크스페이스(%s) 멤버를 변경하였습니다.","변경 일시 : %s","멤버","감사합니다."),
