...
-- 프레임워크 버전
insert into TB_FRAMEWORK_VERSION (FRAMEWORK_VERSION_ID, MOD_DATE, REG_DATE, CUDA_VERSION, FRAMEWORK_VERSION, FRAMEWORK_TYPE)
values  (1, null, null, '12.1', '2.1.0', 'PYTORCH'),
        (2, null, null, '12.1', '2.12.0', 'TENSORFLOW'),
        (3, null, null, '11.8', '1.14.0', 'PYTORCH'),
        (4, null, null, '11.8', '2.10.1', 'TENSORFLOW'),
        (5, null, now(), '11.8', '2.2.1', 'PYTORCH'),
        (6, null, now(), '11.8', '2.2.0', 'PYTORCH'),
        (7, null, now(), '11.8', '2.1.2', 'PYTORCH'),
        (8, null, now(), '11.8', '2.1.1', 'PYTORCH'),
        (9, null, now(), '11.8', '2.1.0', 'PYTORCH'),
        (10, null, now(), '11.7', '2.0.1', 'PYTORCH'),
        (11, null, now(), '11.7', '2.0.0', 'PYTORCH'),
        (12, null, now(), '11.7', '1.13.0', 'PYTORCH'),
        (13, null, now(), '11.7', '2.9.1', 'TENSORFLOW'),
        (14, null, now(), '11.6', '1.13.1', 'PYTORCH'),
        (15, null, now(), '11.6', '1.13.0', 'PYTORCH'),
        (16, null, now(), '11.6', '1.12.0', 'PYTORCH'),
        (17, null, now(), '11.6', '2.8.0', 'TENSORFLOW'),
        (18, null, now(), '11.3', '1.9.0', 'PYTORCH'),
        (19, null, now(), '11.3', '2.5.0', 'TENSORFLOW'),
        (20, null, now(), '11.1', '1.8.0', 'PYTORCH'),
        (21, null, now(), '11.1', '2.3.1', 'TENSORFLOW'),
        (22, null, now(), '10.2', '1.12.1', 'PYTORCH'),
        (23, null, now(), '10.2', '1.12.0', 'PYTORCH'),
        (24, null, now(), '10.2', '1.11.0', 'PYTORCH'),
        (25, null, now(), '10.2', '1.10.1', 'PYTORCH'),
        (26, null, now(), '10.2', '1.10.0', 'PYTORCH'),
        (27, null, now(), '10.2', '1.9.1', 'PYTORCH'),
        (28, null, now(), '10.2', '1.9.0', 'PYTORCH'),
        (29, null, now(), '10.2', '1.8.1', 'PYTORCH'),
        (30, null, now(), '10.2', '1.8.0', 'PYTORCH'),
        (31, null, now(), '9.2', '1.7.1', 'PYTORCH'),
        (32, null, now(), '9.2', '1.7.0', 'PYTORCH'),
        (33, null, now(), '9.2', '1.6.0', 'PYTORCH'),
        (34, null, now(), '9.2', '1.5.1', 'PYTORCH'),
        (35, null, now(), '9.2', '1.5.0', 'PYTORCH'),
...
-- 빌트인 이미지 초기값
insert into TB_BUILT_IN_IMAGE (IMAGE_ID, COMMAND, CUDA_VERSION, DESCRIPTION, FRAMEWORK_VERSION, PORTS,
                               THUMBNAIL_SAVE_FILENAME, THUMBNAIL_SAVE_PATH, TITLE, FRAMEWORK_TYPE)
values (3, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '12.1',
        'NVIDIA의 nvcr.io/nvidia/pytorch:23.07-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 12.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.1.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-23.07-cuda12.1', 'VSCODE'),
       (4, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.8',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.12-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.8을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.14.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-22.12-cuda11.8', 'VSCODE'),
       (5, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.7',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.08-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.7을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.13.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-22.08-cuda11.7', 'VSCODE'),
       (6, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.6',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.04-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.6을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.12.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-22.04-cuda11.6', 'VSCODE'),
       (7, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.3',
        'NVIDIA의 nvcr.io/nvidia/pytorch:21.06-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.3을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.9.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-21.06-cuda11.3', 'VSCODE'),
       (8, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.1',
        'NVIDIA의 nvcr.io/nvidia/pytorch:20.12-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.8.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-20.12-cuda11.1', 'VSCODE'),
       (9,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '12.1',
        'NVIDIA의 nvcr.io/nvidia/pytorch:23.07-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 12.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.1.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:pytorch-23.07-cuda12.1', 'JUPYTER'),
       (10,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.8',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.12-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.8을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.14.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:pytorch-22.12-cuda11.8', 'JUPYTER'),
       (11,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.7',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.08-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.7을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.13.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:pytorch-22.08-cuda11.7', 'JUPYTER'),
       (12,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.6',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.04-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.6을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.12.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:pytorch-22.04-cuda11.6', 'JUPYTER'),
       (13,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.3',
        'NVIDIA의 nvcr.io/nvidia/pytorch:21.06-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.3을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.9.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:pytorch-21.06-cuda11.3', 'JUPYTER'),
       (14,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.1',
        'NVIDIA의 nvcr.io/nvidia/pytorch:20.12-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.8.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:pytorch-20.12-cuda11.1', 'JUPYTER'),
       (15, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '12.1',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:23.07-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 12.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.12.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:pytorch-23.07-cuda12.1', 'VSCODE'),
       (16, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.8',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.12-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.8을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.10.1', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:tensorflow-22.12-cuda11.8', 'VSCODE'),
       (17, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.7',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.08-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.7을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.9.1', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:tensorflow-22.08-cuda11.7', 'VSCODE'),
       (18, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.6',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.04-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.6을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.8.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:tensorflow-22.04-cuda11.6', 'VSCODE'),
       (19, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.3',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:21.06-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.3을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.5.0', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:tensorflow-21.06-cuda11.3', 'VSCODE'),
       (20, 'code-server --cert=false --auth=none --bind-addr=0.0.0.0:8080', '11.1',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:20.12-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.3.1', '{"vscode": 8080}', null, null, 'vs-code:xiilab/astrago:tensorflow-21.06-cuda11.3', 'VSCODE'),
       (21,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '12.1',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:23.07-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 12.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.12.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:tensorflow-23.07-cuda12.1', 'JUPYTER'),
       (22,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.8',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.12-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.8을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.10.1', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:tensorflow-22.12-cuda11.8', 'JUPYTER'),
       (23,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.7',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.08-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.7을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.9.1', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:tensorflow-22.08-cuda11.7', 'JUPYTER'),
       (24,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.6',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.04-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.6을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.8.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:tensorflow-22.04-cuda11.6', 'JUPYTER'),
       (25,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.3',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:21.06-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.3을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.5.0', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:tensorflow-21.06-cuda11.3', 'JUPYTER'),
       (26,
        'jupyter lab --allow-root --ip=* --port=8888 --NotebookApp.token='''' --NotebookApp.allow_origin=''*'' --notebook-dir=/',
        '11.1',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:20.12-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.3.1', '{"jupyter": 8888}', null, null, 'vs-code:xiilab/astrago:tensorflow-20.12-cuda11.1', 'JUPYTER'),
       (27, null, '12.1',
        'NVIDIA의 nvcr.io/nvidia/pytorch:23.07-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 12.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.1.0', null, null, null, 'xiilab/astrago:pytorch-23.07-cuda12.1', 'PYTORCH'),
       (28, null, '11.8',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.12-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.8을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.14.0', null, null, null, 'xiilab/astrago:pytorch-22.12-cuda11.8', 'PYTORCH'),
       (29, null, '11.7',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.08-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.7을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.13.0', null, null, null, 'xiilab/astrago:pytorch-22.08-cuda11.7', 'PYTORCH'),
       (30, null, '11.6',
        'NVIDIA의 nvcr.io/nvidia/pytorch:22.04-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.6을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.12.0', null, null, null, 'xiilab/astrago:pytorch-22.04-cuda11.6', 'PYTORCH'),
       (31, null, '11.3',
        'NVIDIA의 nvcr.io/nvidia/pytorch:21.06-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.3을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.9.0', null, null, null, 'xiilab/astrago:pytorch-21.06-cuda11.3', 'PYTORCH'),
       (32, null, '11.1',
        'NVIDIA의 nvcr.io/nvidia/pytorch:20.12-py 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '1.8.0', null, null, null, 'xiilab/astrago:pytorch-20.12-cuda11.1', 'PYTORCH'),
       (33, null, '12.1',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:23.07-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 12.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.12.0', null, null, null, 'xiilab/astrago:tensorflow-23.07-cuda12.1', 'TENSORFLOW'),
       (34, null, '11.8',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.12-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.8을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.10.1', null, null, null, 'xiilab/astrago:tensorflow-22.12-cuda11.8', 'TENSORFLOW'),
       (35, null, '11.7',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.08-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.7을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.9.1', null, null, null, 'xiilab/astrago:tensorflow-22.08-cuda11.7', 'TENSORFLOW'),
       (36, null, '11.6',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:22.04-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.6을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.8.0', null, null, null, 'xiilab/astrago:tensorflow-22.04-cuda11.6', 'TENSORFLOW'),
       (37, null, '11.3',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:21.06-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.3을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.5.0', null, null, null, 'xiilab/astrago:tensorflow-21.06-cuda11.3', 'TENSORFLOW'),
       (38, null, '11.1',
        'NVIDIA의 nvcr.io/nvidia/tensorflow:20.12-tf2-py3 이미지를 기반으로 하여, PyTorch를 활용한 딥러닝 연구 및 개발을 더욱 효율적으로 수행할 수 있도록 설계된 이미지입니다. 이 이미지에는 Jupyter Lab과 Visual Studio Code (VS Code)가 사전 설치되어 있으며, CUDA 11.1을 지원하여 최신 GPU 가속 기능을 최대한 활용할 수 있습니다.',
        '2.3.1', null, null, null, 'xiilab/astrago:tensorflow-20.12-cuda11.1', 'TENSORFLOW'),
       (39, null, '11.3', 'horovod 실행을 위한 이미지 입니다.', '1.12.1', null, null, null, 'torch1.12.1-horovod-cuda11.3',
        'PYTORCH')
ON DUPLICATE KEY UPDATE IMAGE_ID = IMAGE_ID;
