...
# VALUES (1, '1.0', '1.1', '1.0', null, null),
...
#
# # 이미지 초기값
# INSERT INTO TB_IMAGE (IMAGE_TYPE, IMAGE_ID, MOD_DATE, REG_DATE, REG_USER_ID, REG_USER_NAME, REG_USER_REAL_NAME, DELETE_YN, IMAGE_NAME, REPOSITORY_AUTH_TYPE, WORKLOAD_TYPE)
...
# # (IMAGE_ID, DESCRIPTION, THUMBNAIL_SAVE_FILENAME, THUMBNAIL_SAVE_PATH, TITLE, FRAMEWORK_TYPE, CUDA_VERSION, FRAMEWORK_VERSION, PORTS, COMMAND)
# # VALUES
# #     (3, 'vs-code:torch1.7.1-tensorflow2.4.1-cuda11.0', null, null, 'vs-code:torch1.7.1-tensorflow2.4.1-cuda11.0', 'VSCODE', '11.0', '1.7.1', '{"vscode": 8080}', 'code-server'),
# #     (4, 'vs-code:torch2.0.1-tensorflow2.11.0-cuda11.7', null, null, 'vs-code:torch2.0.1-tensorflow2.11.0-cuda11.7', 'VSCODE', '11.7', '2.0.1', '{"vscode": 8080}', 'code-server'),
# #     (5, 'vs-code:torch2.2.1-tensorflow2.14.0-cuda12.1', null, null, 'vs-code:torch2.2.1-tensorflow2.14.0-cuda12.1', 'VSCODE', '12.1', '2.2.1', '{"vscode": 8080}', 'code-server'),
# #     (6, 'vs-code:torch2.2.1-tensorflow2.14.0-cuda11.8', null, null, 'vs-code:torch2.2.1-tensorflow2.14.0-cuda11.8', 'VSCODE', '11.8', '2.2.1', '{"vscode": 8080}', 'code-server'),
# #     (7, 'jupyter-notebook:torch1.7.1-tensorflow2.4.1-cuda11.0', null, null, 'jupyter-notebook:torch1.7.1-tensorflow2.4.1-cuda11.0', 'JUPYTER', '11.0', '1.7.1', '{"jupyter": 8888}', 'jupyter notebook'),
# #     (8, 'jupyter-notebook:torch2.0.1-tensorflow2.11.0-cuda11.7', null, null, 'jupyter-notebook:torch2.0.1-tensorflow2.11.0-cuda11.7', 'JUPYTER', '11.7', '2.0.1', '{"jupyter": 8888}', 'jupyter notebook'),
# #     (9, 'jupyter-notebook:torch2.2.1-tensorflow2.14.0-cuda12.1', null, null, 'jupyter-notebook:torch2.2.1-tensorflow2.14.0-cuda12.1', 'JUPYTER', '12.1', '2.2.1', '{"jupyter": 8888}', 'jupyter notebook'),
# #     (10, 'jupyter-notebook:torch2.2.1-tensorflow2.14.0-cuda11.8', null, null, 'jupyter-notebook:torch2.2.1-tensorflow2.14.0-cuda11.8', 'JUPYTER', '11.8', '2.2.1', '{"jupyter": 8888}', 'jupyter notebook'),
# #     (11, 'torch1.7.1-tensorflow2.4.1-cuda11.0', null, null, 'torch1.7.1-tensorflow2.4.1-cuda11.0', 'PYTORCH', '11.0', '1.7.1', null, null),
# #     (12, 'torch2.0.1-tensorflow2.11.0-cuda11.7', null, null, 'torch2.0.1-tensorflow2.11.0-cuda11.7', 'PYTORCH', '11.7', '2.0.1', null, null),
# #     (13, 'torch2.2.1-tensorflow2.14.0-cuda12.1', null, null, 'torch2.2.1-tensorflow2.14.0-cuda12.1', 'PYTORCH', '12.1', '2.2.1', null, null),
# #     (14, 'torch2.2.1-tensorflow2.14.0-cuda11.8', null, null, 'torch2.2.1-tensorflow2.14.0-cuda11.8', 'PYTORCH', '11.8', '2.2.1', null, null)
# # ON DUPLICATE KEY UPDATE IMAGE_ID = IMAGE_ID;
#
# # 허브 초기값
