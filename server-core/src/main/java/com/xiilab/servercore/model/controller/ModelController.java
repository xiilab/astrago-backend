...
public class ModelController {
	...
	public ResponseEntity<ModelDTO.FileInfo> getAstragoModelFileInfo(@PathVariable(name = "modelId") Long modelId,
		@RequestParam(value = "filePath") String filePath){
	...
	public ResponseEntity<ModelDTO.FileInfo> getLocalModelFileInfo(@PathVariable(name = "modelId") Long modelId,
		@RequestParam(value = "filePath") String filePath){
