...
public class HubDTO {
	...
	/*protected static HubDTO hubCategoryMappingEntityToDto(HubEntity hubEntity, Map<Long, Set<String>> typesMap) {
			return HubDTO.builder()
				.hubId(hubEntity.getHubId())
				.title(hubEntity.getTitle())
				.description(hubEntity.getDescription())
				.thumbnailSavePath(hubEntity.getThumbnailSavePath())
				.image(hubEntity.getImage())
		...
		@Getter
		@SuperBuilder
		public static class HubDTODetail extends HubDTO {
			private Map<String, String> envs;
			private Map<String, Integer> ports;
			private String sourceCodeUrl;
			private String sourceCodeBranch;
			...
			public static HubDTODetail toDto(HubEntity hubEntity, Map<Long, Set<String>> typesMap) {
				ObjectMapper objectMapper = new ObjectMapper();
				try {
					return HubDTODetail.builder()
						.hubId(hubEntity.getHubId())
						.title(hubEntity.getTitle())
						.description(hubEntity.getDescription())
						.thumbnailSavePath(hubEntity.getThumbnailSavePath())
		...
		@Getter
		@SuperBuilder
		public static class HubDTOs {
			private List<HubDTO> hubDTOs;
			private long totalCount;

			public static HubDTOs hubCategoryMappingEntitysToDtos(List<HubCategoryMappingEntity> hcmes, Long totalCount, Map<Long, Set<String>> typesMap) {
				return HubDTOs.builder()
					.hubDTOs(hcmes.stream().map(hcm -> hubCategoryMappingEntityToDto(hcm.getHubEntity(), typesMap)).toList())
					.totalCount(totalCount)
					.build();
			}
		}*/
