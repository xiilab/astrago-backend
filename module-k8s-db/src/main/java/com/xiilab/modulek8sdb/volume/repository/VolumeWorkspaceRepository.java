...
public interface VolumeWorkspaceRepository extends JpaRepository<VolumeWorkSpaceMappingEntity, Long> {
	...
	List<VolumeWorkSpaceMappingEntity> findByWorkspaceResourceName(
	...
	VolumeWorkSpaceMappingEntity findByWorkspaceResourceNameAndVolumeId(
		@Param("workspaceResourceName") String workspaceResourceName, @Param("volumeId") Long volumeId);
	...
	void deleteByVolumeIdAndWorkspaceResourceName(@Param("volumeId") Long modelId,
		@Param("volumeId") String workspaceResourceName);
}
