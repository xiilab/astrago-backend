...
public class InteractiveOptimizationAlertJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
		...
		log.info("interactive resource optimization {} alert job start....", context.getJobDetail().getKey().getName());
