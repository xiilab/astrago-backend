...
public class InteractiveResourceOptimizationJob implements Job {
	@Override
	public void execute(JobExecutionContext context) {
		log.info("interactive resource optimization {} job start....", context.getJobDetail().getDescription());
