...
public enum Promql {
	...
	GPU_USAGE("avg(DCGM_FI_DEV_GPU_UTIL{%s}) by(gpu, kubernetes_node, modelName, pod)", "GPU 사용률 조회", "GPU"),
	...
	NODE_DISK_SIZE("max by (mountpoint) "
		+ "(sum(label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%s}"
		+ " or "
		+ "label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%s}"
		+ " or "
		+ "label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%s}))"
	...
	NODE_ROOT_DISK_USAGE_SIZE(
		"(label_replace(node_filesystem_size_bytes{fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or "
			+ "label_replace(node_filesystem_size_bytes{fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or "
			+ "label_replace(node_filesystem_size_bytes{fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s}) - "
			+ "(label_replace(node_filesystem_avail_bytes{fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or "
			+ "label_replace(node_filesystem_avail_bytes{fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or "
			+ "label_replace(node_filesystem_avail_bytes{fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s})",
		"Node Disk 사용량 조회", "NODE"),
	NODE_DISK_USAGE("(max by (mountpoint) (sum(label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s})) - max by (mountpoint) (sum(label_replace(node_filesystem_avail_bytes{job=\"node-exporter\", fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or label_replace(node_filesystem_avail_bytes{job=\"node-exporter\", fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or label_replace(node_filesystem_avail_bytes{job=\"node-exporter\", fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s}))) / max by (mountpoint) (sum(\n"
		+ "label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} or label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s})) * 100 ", "Node Disk 사용량", "NODE"),
	TOTAL_NODE_DISK_SIZE_BYTES("sum(node_filesystem_size_bytes{fstype=\"ext4\"} or node_filesystem_size_bytes{fstype=\"vfat\"} or node_filesystem_size_bytes{fstype=\"xfs\"})", "전체 노드의 DISK SIZE(Bytes) 조회", "NODE"),
	USAGE_NODE_DISK_SIZE_BYTES("sum(node_filesystem_size_bytes{fstype=\"ext4\"} or node_filesystem_size_bytes{fstype=\"vfat\"} or node_filesystem_size_bytes{fstype=\"xfs\"}) - sum(node_filesystem_avail_bytes{fstype=\"ext4\"} or node_filesystem_avail_bytes{fstype=\"vfat\"} or node_filesystem_avail_bytes{fstype=\"xfs\"})", "전체 노드의 DISK 사용중인 Bytes 조회", "NODE"),
	...
	NODE_TOTAL_DISK_SIZE_BYTE("sum(label_replace(node_filesystem_size_bytes{fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s}"
		+ " or "
		+ "label_replace(node_filesystem_size_bytes{fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s}"
		+ " or "
		+ "label_replace(node_filesystem_size_bytes{fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s}"
		+ ")", "", "NODE"),
	NODE_USAGE_DISK_SIZE_BYTE("sum((label_replace(node_filesystem_size_bytes{fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} "
		+ "or "
		+ "label_replace(node_filesystem_size_bytes{fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} "
		+ "or "
		+ "label_replace(node_filesystem_size_bytes{fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s})"
		+ " - "
		+ "label_replace(node_filesystem_avail_bytes{fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} "
		+ "or "
		+ "label_replace(node_filesystem_avail_bytes{fstype=\"vfat\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s} "
		+ "or "
		+ "label_replace(node_filesystem_avail_bytes{fstype=\"xfs\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{%1$s})"
		,"","NODE"),
	...
	HPA_UNHEALYHY_COUNT("count(kube_horizontalpodautoscaler_status_condition{condition=\"AbleToScale\", status=\"false\"} != 0)", "HPA unhealthy Count", "HPA"),
	...
	// CPU
	RESOURCE_OPTIMIZATION_CPU(
		"sum(max_over_time(node_namespace_pod_container:container_cpu_usage_seconds_total:sum_irate{pod =~ \"wl-.*\"}[%sh])) by (namespace, pod) < %s and on (namespace, pod) (kube_pod_created < %s)",
		"n시간 동안 최대 CPU 사용량이 일정 수준 미만인 워크로드 조회", "CPU"),
	// MEM
	RESOURCE_OPTIMIZATION_MEM(
		"((sum(max_over_time(container_memory_working_set_bytes{pod=~\"wl-.*\"}[%1$sh])) by(namespace, pod)/sum(max_over_time(kube_pod_container_resource_limits{pod=~\"wl-.*\", resource = \"memory\"}[%1$sh])) by (namespace, pod) != 0)* 100) < %2$s and on (pod,namespace) (kube_pod_created < %3$s)",
	...
	REPORT_SYSTEM_INFO_DISK ("max by (node) (sum(label_replace(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"ext4\"}, \"internal_ip\", \"$1\", \"instance\", \"(.*):.*\") * on(internal_ip) group_left(node) kube_node_info{}))", "", ""),
	...
	REPORT_SYSTEM_AVG_MEM("avg_over_time(label_replace(((node_memory_MemTotal_bytes - node_memory_MemFree_bytes - (node_memory_Cached_bytes + node_memory_Buffers_bytes + node_memory_SReclaimable_bytes)) / node_memory_MemTotal_bytes * 100), \"internal_ip\", \"$1\", \"instance\", \"(.*):(.*)\")[6h:]) * on (internal_ip) group_left(node) kube_node_info{}", "", ""),
	...
	REPORT_SYSTEM_MAX_MEM("max_over_time(label_replace(((node_memory_MemTotal_bytes - node_memory_MemFree_bytes - (node_memory_Cached_bytes + node_memory_Buffers_bytes + node_memory_SReclaimable_bytes)) / node_memory_MemTotal_bytes * 100), \"internal_ip\", \"$1\", \"instance\", \"(.*):(.*)\")[6h:]) * on (internal_ip) group_left(node) kube_node_info{}", "", ""),
	REPORT_SYSTEM_DISK_USAGE_90("label_replace((sum(node_filesystem_size_bytes{fstype=\"ext4\"} or node_filesystem_size_bytes{fstype=\"vfat\"} or node_filesystem_size_bytes{fstype=\"xfs\"}) - sum(node_filesystem_avail_bytes{fstype=\"ext4\"} or node_filesystem_avail_bytes{fstype=\"vfat\"} or node_filesystem_avail_bytes{fstype=\"xfs\"})) / (sum(node_filesystem_size_bytes{fstype=\"ext4\"} or node_filesystem_size_bytes{fstype=\"vfat\"} or node_filesystem_size_bytes{fstype=\"xfs\"})) * 100,  \"internal_ip\", \"$1\", \"instance\", \"(.*):(.*)\") * on (internal_ip) group_left(node) kube_node_info{} > 90","",""),
	REPORT_SYSTEM_DISK_USAGE("label_replace(sum(node_filesystem_size_bytes{fstype=\"ext4\"} or node_filesystem_size_bytes{fstype=\"vfat\"} or node_filesystem_size_bytes{fstype=\"xfs\"}) - sum(node_filesystem_avail_bytes{fstype=\"ext4\"} or node_filesystem_avail_bytes{fstype=\"vfat\"} or node_filesystem_avail_bytes{fstype=\"xfs\"}) / (sum(node_filesystem_size_bytes{fstype=\"ext4\"} or node_filesystem_size_bytes{fstype=\"vfat\"} or node_filesystem_size_bytes{fstype=\"xfs\"})) * 100,  \"internal_ip\", \"$1\", \"instance\", \"(.*):(.*)\") * on (internal_ip) group_left(node) kube_node_info{}","",""),
	...
	REPORT_SYSTEM_AVG_GPU_TEMP("avg(avg_over_time(DCGM_FI_DEV_GPU_TEMP[5m])) by (kubernetes_node, gpu)","",""),
	REPORT_SYSTEM_MAX_GPU_TEMP("max(max_over_time(DCGM_FI_DEV_GPU_TEMP[5m])) by (kubernetes_node, gpu)","",""),
	REPORT_SYSTEM_AVG_GPU_USAGE("avg(avg_over_time(DCGM_FI_DEV_GPU_UTIL[5m])) by (gpu, kubernetes_node, modelName)", "", ""),
	REPORT_SYSTEM_MAX_GPU_USAGE("max(max_over_time(DCGM_FI_DEV_GPU_UTIL[5m])) by (gpu, kubernetes_node, modelName)", "", ""),
	...
	SYSTEM_DISK_BYTE("max by (mountpoint) (sum(node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"ext4\"), %1$s} or node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"vfat\"), %1$s} or node_filesystem_size_bytes{job=\"node-exporter\", fstype=\"xfs\"), %1$s})", "NDOE의 총 DISK, 필수 값 nodeName, 단위 : Byte ", "INSTANCE"),
